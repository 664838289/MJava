...
//        if(startP.matcher(bodyStr).find() || runOnUIP.matcher(bodyStr).find() ||
//                executeP.matcher(bodyStr).find() || executeOnExP.matcher(bodyStr).find() ||
//                postP.matcher(bodyStr).find() || postDelayedP.matcher(bodyStr).find() ||
//                postAtTimeP.matcher(bodyStr).find() || sendMsgP.matcher(bodyStr).find() ||
//                sendMsgDelayP.matcher(bodyStr).find() || sendEmptyMsgP.matcher(bodyStr).find()
//                || sendMsgAtTimeP.matcher(bodyStr).find()){
//            return true;
//        }
    ...
    public static boolean isContainThreadCall_2(String bodyStr){
        if(bodyStr.contains(".start()")||bodyStr.contains(".runOnUiThread(")||
                bodyStr.contains(".execute(") || bodyStr.contains(".executeOnExecutor(")||
                bodyStr.contains(".post(") || bodyStr.contains(".postDelayed(")||
                bodyStr.contains(".postAtTime(") || bodyStr.contains(".sendMessage(")||
                bodyStr.contains(".sendMessageDelayed(")|| bodyStr.contains(".sendEmptyMessage(")||
                bodyStr.contains(".sendMessageAtTime(")){
            return true;
        }
        return false;
    }
    public static boolean isThreadMethodDeclaration(MethodDeclaration p){
        ...
        else if("doInBackground".equals(name)&&modifiers.contains(Modifier.PROTECTED)){
            return true;
        }
